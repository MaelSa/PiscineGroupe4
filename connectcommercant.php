...
<html>
	<head>
		<title>Connection Commercant</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
		<div id="page-wrapper">
			...
			<fieldset class="fieldset ">
				...
				<div class="form-group input-text-wrapper"> 
					<a href="InscriptionCommercant.php">
			...
			<?php
				...
				if(isset($_POST['formsend'])){
					...
					$q = $db->query("SELECT *FROM commercant");
					while ($user = $q->fetch()){
						if ($user['AdresseMail_Commercant'] == $mail){
							$test_id=1;
						}
						if (password_verify($mdp, $user['MDPCrypte_Commercant'])) {
							$test_mdp=1;
						}
					}
